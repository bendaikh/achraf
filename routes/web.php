...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('hr')->name('hr.')->middleware('hr:view_hr')->group(function () {
        ...
        Route::get('/contracts/{contract}/edit', [EmployeeContractController::class, 'edit'])->middleware('hr:edit_hr')->name('contracts.edit');
        Route::put('/contracts/{contract}', [EmployeeContractController::class, 'update'])->middleware('hr:edit_hr')->name('contracts.update');
        Route::post('/contracts/{contract}/amend', [EmployeeContractController::class, 'amend'])->middleware('hr:edit_hr')->name('contracts.amend');
        Route::get('/attendance', [AttendanceController::class, 'index'])->name('attendance.index');
        Route::post('/attendance', [AttendanceController::class, 'store'])->middleware('hr:edit_hr')->name('attendance.store');
        Route::post('/attendance/month', [AttendanceController::class, 'storeMonth'])->middleware('hr:edit_hr')->name('attendance.store-month');
        ...
        Route::put('/compensations/{compensation}', [CompensationController::class, 'update'])->middleware('hr:view_salaries')->name('compensations.update');
        Route::post('/compensations/{compensation}/status', [CompensationController::class, 'changeStatus'])->middleware('hr:view_salaries')->name('compensations.status');
        Route::post('/adjustments', [CompensationController::class, 'storeAdjustment'])->middleware('hr:view_salaries')->name('adjustments.store');
        Route::put('/adjustments/{adjustment}', [CompensationController::class, 'updateAdjustment'])->middleware('hr:view_salaries')->name('adjustments.update');
