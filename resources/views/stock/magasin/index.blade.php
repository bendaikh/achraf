            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-lg shadow border border-gray-100 p-5 flex items-center">
                        <form method="get" action="{{ route('stock.magasin.index') }}" class="flex flex-wrap items-end gap-3 w-full">
                            ...
                            <div>
                                ...
                                <div class="flex rounded-lg border border-gray-200 overflow-hidden">
                                    <a href="{{ route('stock.magasin.index', array_filter(['q' => request('q')])) }}"
                                        class="px-3 py-2 text-sm {{ request('filter') !== 'low' ? 'bg-emerald-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50' }}">Tous</a>
                                    <a href="{{ route('stock.magasin.index', array_filter(['q' => request('q'), 'filter' => 'low'])) }}"
