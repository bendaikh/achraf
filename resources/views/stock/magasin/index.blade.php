...
@section('sidebar_page_title', 'Stock Magasin')
...
<main class="flex-1 w-full min-w-0 overflow-y-auto min-h-screen">
            <div class="p-4 sm:p-6 lg:p-8">
                <div class="mb-6 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Stock Magasin</h1>
                        <p class="text-gray-500 mt-1">Gestion du stock des produits en magasin (POS)</p>
                    </div>
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('stock.magasin.export', array_merge(['format' => 'excel'], request()->query())) }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition">
                            Exporter Excel
                        </a>
                        <a href="{{ route('stock.magasin.export', array_merge(['format' => 'pdf'], request()->query())) }}" class="inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition">
                            Exporter PDF
                        </a>
                    </div>
                ...
                <x-table-filters
                    :action="route('stock.magasin.index')"
                ...
                <x-table-list-toolbar table-id="stock-magasin" />
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    <div class="overflow-x-auto">
                        <table data-lm-table="stock-magasin" class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider lm-col lm-col-stock column-stock" data-lm-col="stock">Actions</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 lm-col lm-col-nom column-nom" data-lm-col="nom">
                                            <div class="flex items-center">
                                                ...
                                                <svg class="h-4 w-4 ml-2 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" title="Produit Magasin">
                                        ...
                                        @php $qty = (int) ($product->stock_magasin ?? 0); @endphp
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm lm-col lm-col-actions column-actions" data-lm-col="actions">
                                            <a href="{{ route('stock.magasin.edit', $product) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-medium hover:from-emerald-700 hover:to-teal-700">
                                                Ajuster
                                            </a>
                                        </td>
                                    </tr>
