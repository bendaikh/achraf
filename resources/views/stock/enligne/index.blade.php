...
@section('title', 'Stock Enligne')

@section('sidebar_page_title', 'Stock Enligne')
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($products as $product)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                            <a href="{{ route('stock.enligne.edit', $product) }}" class="inline-flex items-center px-3 py-1.5 rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-white text-xs font-medium hover:from-blue-700 hover:to-purple-700">
                                                Ajuster
                                            </a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">Aucun produit enligne ne correspond à votre recherche.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
