<form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="space-y-8">
        <div>
            <h3 class="text-sm font-semibold text-gray-900">Logo de l'entreprise</h3>
            <p class="text-sm text-gray-500 mt-1">Image affichée sur vos documents et dans l'application</p>

            <div class="mt-5 flex flex-col sm:flex-row sm:items-start gap-6">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <label class="inline-flex items-center px-4 py-2 bg-[#0a5d8a] text-white rounded-lg hover:bg-[#084a6e] cursor-pointer text-sm font-medium">
                            Télécharger
        ...
        <div class="border-t border-gray-100 pt-8">
            <h3 class="text-sm font-semibold text-gray-900">Cachet de l'entreprise</h3>
        ...
        <div class="border-t border-gray-100 pt-8">
            <h3 class="text-sm font-semibold text-gray-900">Informations de l'entreprise</h3>
        ...
        <div class="sticky bottom-0 flex justify-end border-t border-gray-100 bg-white/95 backdrop-blur -mx-6 px-6 py-3">
            <button type="submit" class="inline-flex items-center px-8 py-2.5 bg-[#0a5d8a] text-white rounded-lg hover:bg-[#084a6e] transition duration-150 text-sm font-medium shadow-sm">
                Enregistrer
            </button>
        </div>
    </div>
