...
@section('sidebar_page_title', 'Fournisseurs')
    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
            <div>
                ...
                <p class="text-gray-500 mt-1">Gérez vos fournisseurs</p>
            </div>
            <a href="{{ route('suppliers.create') }}" class="w-full sm:w-auto justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition duration-150 flex items-center space-x-2 shrink-0">
        ...
        <x-crm-import-panel
            label="Fournisseurs"
            :template-route="route('suppliers.import.template')"
            :import-route="route('suppliers.import')"
        />
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <x-table-pagination :paginator="$suppliers" item-label="fournisseurs" />
        </div>
    </div>
</main>
@endsection
