...
<main class="flex-1 w-full min-w-0">
        <header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-10">
            <div class="px-8 py-4 flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Nouvel avoir</h2>
                    <p class="text-sm text-gray-600 mt-1">Créer un nouveau avoir client</p>
                </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('credit-notes.store') }}" method="POST" id="creditNoteForm" data-compact-nested="items">
                @csrf
