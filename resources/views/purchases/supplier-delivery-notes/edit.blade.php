...
<main class="flex-1 w-full min-w-0">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('supplier-delivery-notes.update', $supplierDeliveryNote) }}" method="POST" id="supplierDeliveryNoteForm" data-compact-nested="items">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="min-w-0">
                            ...
                            <x-supplier-select-with-create
                                :suppliers="$suppliers"
                                :selected-id="old('supplier_id', $supplierDeliveryNote->supplier_id)"
                            />
                        </div>
