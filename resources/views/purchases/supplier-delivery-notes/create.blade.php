...
<main class="flex-1 w-full min-w-0">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('supplier-delivery-notes.store') }}" method="POST" id="quoteForm" data-compact-nested="items">
                @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="delivery_number" value="{{ old('delivery_number', $deliveryNumber) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Saisir le numéro de bon de livraison">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="delivery_date" value="{{ date('Y-m-d') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Réception prévue</label>
                            <input type="date" name="expected_reception_date" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
