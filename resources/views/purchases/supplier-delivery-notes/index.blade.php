...
<main class="flex-1 w-full min-w-0">
        ...
        <div class="p-8">
            ...
            <x-table-list-toolbar table-id="supplier-delivery-notes" />
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="overflow-x-auto">
                    <table data-lm-table="supplier-delivery-notes" class="w-full">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium lm-col lm-col-actions column-actions" data-lm-col="actions">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <x-libromart-pdf-actions
                                                :print-route="route('supplier-delivery-notes.print', $deliveryNote)"
                                                :pdf-route="route('supplier-delivery-notes.pdf', $deliveryNote)"
                                            />
