...
<main class="flex-1 w-full min-w-0">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('supplier-purchase-orders.store') }}" method="POST" id="purchaseOrderForm" data-compact-nested="items">
                @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="order_number" value="{{ old('order_number', $orderNumber) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Saisir le numéro de BC fournisseur">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="order_date" value="{{ date('Y-m-d') }}" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        </div>
