...
<main class="flex-1 w-full min-w-0">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('supplier-invoices.update', $supplierInvoice) }}" method="POST" id="invoiceForm" data-compact-nested="items,adjustments" enctype="multipart/form-data">
                @csrf
                @method('PUT')
