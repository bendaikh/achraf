...
<main class="flex-1 w-full min-w-0 overflow-y-auto min-h-screen bg-slate-100/70">
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="min-h-screen flex flex-col">
        @csrf
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <div class="flex items-center gap-2 text-sm text-slate-500 mb-1">
                        ...
                        <span>/</span>
                        <span class="text-slate-800">Nouveau</span>
                    </div>
                    <h1 class="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">Nouveau produit / service</h1>
                </div>
